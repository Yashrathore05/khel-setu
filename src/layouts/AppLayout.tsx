    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-gray-100">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-black/40 border-b border-white/10">
        <div className="mx-auto max-w-6xl px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between gap-2">
          ...
          <Link to="/" className="flex items-center gap-3">
            <img src="/images/logo.png" alt="Khel Setu" className="h-14 sm:h-16 md:h-20 w-14 sm:w-16 md:w-20 rounded-full object-contain bg-white border border-white/20 shadow-lg drop-shadow-[0_2px_10px_rgba(59,130,246,0.35)]" />
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-black/80 backdrop-blur supports-[backdrop-filter]:bg-black/60">
        <div className="mx-auto max-w-6xl px-4 py-2 grid grid-cols-5 gap-1">
          ...
          <TabLink to="/events" label="Events" icon={(isActive) => (
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={isActive ? "text-white" : "text-gray-300"}><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
          )} />
        </div>
      </nav>
      )}
